<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="recivecomplain.aspx.cs" Inherits="recivecomplain" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3 style="top: 286px; left: 248px; position: absolute; height: 19px; width: 270px; color: #3333CC">RECEIVED COMPLAINS</h3>
    ...
    <asp:Button ID="Button1" runat="server" Text="SEARCH" style="top: 408px; left: 426px; position: absolute; height: 26px; width: 86px" />
