...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <asp:TextBox ID="name_txt" runat="server" style="top: 421px; left: 292px; position: absolute; height: 22px; width: 128px"></asp:TextBox>
    <asp:DropDownList ID="DropDownList1" runat="server" style="top: 371px; left: 292px; position: absolute; height: 27px; width: 142px">
        <asp:ListItem>Administartor</asp:ListItem>
